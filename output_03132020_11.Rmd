...
```{r, echo=FALSE}
k_check <- koreatown_area[c("total_hangeul", "total_roman", "chinese", "japanese", "span", "fren", "arabic", "viet", "thai", "turkish")]
print("Koreatown")
sapply(k_check, sum, na.rm=TRUE)

i_check <- itaewon_area[c("total_hangeul", "total_roman", "chinese", "japanese", "span", "fren", "arabic", "viet", "thai", "turkish")]
print("Itaewon")
